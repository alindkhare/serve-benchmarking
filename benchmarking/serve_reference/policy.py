...
import ray
from benchmarking.serve_reference.queues import CentralizedQueues
from benchmarking.serve_reference.utils import logger
...
class RoutePolicy(Enum):
    ...
    in `serve_reference.init` method through name provided here.
    """
