...
from benchmarking.serve_reference.context import TaskContext
from benchmarking.serve_reference.exceptions import RayServeException
from benchmarking.serve_reference.constants import DEFAULT_HTTP_ADDRESS
...
class RayServeHandle:
    ...
    Example:
       >>> handle = serve_reference.get_handle("my_endpoint")
       >>> handle
       RayServeHandle(
    ...
    def get_traffic_policy(self):
        policy_table = serve_reference.api._get_global_state().policy_table
    ...
    def set_backend_config(self, backend_config, backend_tag=None):
        with serve_reference.using_router(self.endpoint_name):
            backend_tag = self._ensure_backend_unique(backend_tag)
            serve_reference.set_backend_config(backend_tag, backend_config)
